...
const MATRIX: Record<Resource, Partial<Record<UserRole, Action[]>>> = {
  ...
  pos_sale:         { owner: ["view", "create"], manager: ["view"], shift_supervisor: ["create"], cashier: ["create"] },
  pos_void:         { owner: CRUD, manager: CRUD, shift_supervisor: ["create"], cashier: ["create"] },
  pos_refund:       { owner: ["create", "view", "update", "delete", "approve", "request"], manager: ["create", "view", "update", "delete", "approve", "request"], shift_supervisor: ["approve"], cashier: ["request"] },
